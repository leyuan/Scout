...
<body id="landing-page">
    ...
    <div id="hero" class="static-header light clearfix">
        <div class="text-heading">
            ...
            <div class="sub-headline home-btn-div">
                <a class="btn home-btn" id="home-btn-card"> Get the card </a>
                <a href="#businesses" class="btn home-btn" id="home-btn-businesses"> Businesses </a>
            </div>
        </div>
    </div>
    ...
    <footer id="contact" class="footer light">
        ...
        <div class="copyright">Simplipay, Inc. 2015 All Rights Reserved.</div>
    </footer>
